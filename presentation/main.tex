...
\begin{frame}{Velocity modes}
    ...
    \begin{figure}
        ...
        \begin{subfigure}[t]{0.32\textwidth}
            \movie[width=\textwidth, height=\textwidth, showcontrols]{} {../anim/kinematics_stretch.mp4}
            % \animategraphics[loop,width=6cm]{40}{../anim/kinematics_stretch/frame}{1}{51}    
            \caption{\color{gray!50} expansion}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \movie[width=\textwidth, height=\textwidth, showcontrols]{} {../anim/kinematics_shear.mp4}
            % \animategraphics[loop,width=6cm]{40}{../anim/kinematics_shear/frame}{1}{51}    
            \caption{shear}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \movie[width=\textwidth, height=\textwidth, showcontrols]{} {../anim/kinematics_rotation.mp4}
...
\begin{frame}{Lid-driven cavity - before/after interface tracking}
    \begin{figure}
        \begin{overprint}
            \only<1>{\centering\includegraphics[height=0.75\textheight]{../figures/cavity_init.pdf}}
            \only<2>{\centering\includegraphics[height=0.75\textheight]{../figures/cavity_last.pdf}}
        \end{overprint}
    \end{figure}
\end{frame}

...
def fig_disp(x, tri, f, candidates, moved, figname) :
    ...
    plt.quiver(moved[:,0],moved[:,2], moved[:,1]-moved[:,0], moved[:,3]-moved[:,2], width=0.008, headlength=4, headaxislength=3.5, fc="w",ec="k",lw=0.5,scale=1, scale_units="xy",zorder=10)
    fig_print(figname)

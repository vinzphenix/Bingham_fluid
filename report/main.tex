...
\section{Failures of the algorithm}

\begin{figure}
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
        \includesvg[width=\textwidth]{../figures/negative_1.svg}
        \caption{Colormap of the strain rate tensor norm.}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
        \includegraphics[width=\textwidth]{../figures/negative_2.pdf}
        \caption{.}
    \end{subfigure}\vspace{6pt}
    \caption{}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.495\textwidth}
        ...
        \caption{Colormap of the virtual field, whose zero level set is the interface corrector.}
    \end{subfigure}\vspace{6pt}
    ...
    \end{subfigure}
    \caption{The interface predictor and corrector are shown respectively as black and red curves. The lower figures show the linear approximation on three neighbouring patches (note the difference in scale).}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Interrogations about the smoothness of the strain-rate norm $\|D\|$. The parametric curves are shown above in the domain $\Omega$, and the evaluation of $\|D\|$ along them is shown below.}

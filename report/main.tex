...
I ran a first simulation with the correct boundary condition (case 2), and a second one where I removed the condition $v_t=0$. These two situations are compared in \cref{fig:poiseuille_vzero,fig:poiseuille_free}. In order to achieve zero tangential shear force, the finite element solution gives a very high pressure gradient near the outflow corners.
